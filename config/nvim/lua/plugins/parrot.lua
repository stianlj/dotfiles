return {
  ...
  keys = {
    ...
    { "<leader>at", "<cmd>PrtChatToggle<cr>",    mode = { "n" }, desc = "Toggle Popup Chat" },
    { "<leader>af", "<cmd>PrtChatFinder<cr>",    mode = { "n" }, desc = "Chat Finder" },
    { "<leader>ar", "<cmd>PrtRewrite<cr>",       mode = { "n" }, desc = "Inline Rewrite" },
