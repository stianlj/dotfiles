...
keymap("n", "<M-h>", require("smart-splits").resize_left)
keymap("n", "<M-j>", require("smart-splits").resize_down)
keymap("n", "<M-k>", require("smart-splits").resize_up)
keymap("n", "<M-l>", require("smart-splits").resize_right)
